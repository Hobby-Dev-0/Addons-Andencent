...
#    maked by userbot X by shivam help thanks keinshin
...
"""Only userbot BOT and DC (Can Use Without Credits) Can Use This Inline WithOut Copyright (Just Give The Credits Pls)
...
if BOT_MSG is None:
    ...
    BOT_LIT = f"Hello Sir MySelf userbot BOT Here For  {LIGHTNINGUSER}'s Protection "
...
async def ho(event):
    ...
    ho = f"""userbotBOT Is Here With Stunning Help !\n
