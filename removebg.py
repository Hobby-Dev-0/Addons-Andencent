...
async def _(event):
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "userbotBOT_RM_BG.png"
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by @userbot_USERBOT_SUPPORT ©™".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @userbot_USERBOT_SUPPORT\n`{}".format(output_file_name.content.decode("UTF-8")))
