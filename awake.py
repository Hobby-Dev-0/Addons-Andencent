...
#make by userbot X bht mehnat lag gayi yrr but banhi gaya 😅           
...
async def amireallyalive(awake):
   ...
   if PHOTO:
     ...
     ALIVE_MESSAGE += "🔰 𝙶𝚁𝙾𝚄𝙿 🔰 : [SUPPORT](https://t.me/userbot_USERBOT_SUPPORT)\n\n"
     ALIVE_MESSAGE += f"💠 [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FuserbotXOP%2FLEGEN-BOT&template=https%3A%2F%2Fgithub.com%2FuserbotXOP%2Fuserbot-ROBOT) 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 [{BOT}](http://github.com/legendxop/legend-bot)  💠\n"   
     await awake.delete() 
