...
#Credit To @legendx22 . Keep credit if you are going to edit it. Join @userbot_USERBOT_SUPPORT
...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await event.edit("`Testing userbot BOT....`")
        ...
        await event.edit("Your[userbot BOT](https:/t.me/hackerget0) is working Fine...\n       Join @teamishere For Any Help......")
